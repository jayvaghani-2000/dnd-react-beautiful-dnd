...
const rowColArray = { toString, moveItemToRow, findItem, getNextRowBlock, flattenArray, getRowOrderedArray, removeItemByCoordinates, removeItemById, calcRowColPositionsInArray, findItemCoordinates, getRowOrderedColOrderedArray, groupCardRowWise }
